                                ...
                                <form action="" method="post" class="mx-1 mx-md-4">
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            ...
                                            <label class="form-label" for="form3Example1c">Room's Name</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-row align-items-center mb-4">
                                        ...
                                        <div class="form-outline flex-fill mb-0">
                                            <input name="user_email" type="text" id="form3Example3c"
                                                class="form-control bg-light" />
                                            <label class="form-label" for="form3Example3c">Room's Type</label>
                                        </div>
                                    </div>
